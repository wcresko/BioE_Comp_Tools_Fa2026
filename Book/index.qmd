...
Each chapter builds on previous material, so I recommend reading them in order, at least initially, starting with @sec-introduction and the software setup in @sec-toolkit. The appendices (@sec-appendix-shortcuts through @sec-appendix-glossary) are look-up references to return to as you work. Key features include:
