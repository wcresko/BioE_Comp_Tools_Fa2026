...
## Why This Book? {#sec-why-this-book}
...
- Program in Python with NumPy, pandas, and matplotlib, and translate between R and Python idioms
...
Each chapter builds on previous material, so I recommend reading them in order, at least initially, starting with @sec-introduction and the software setup in @sec-toolkit. The appendices (@sec-appendix-unix through @sec-appendix-glossary) are look-up references to return to as you work. Key features include:
...
::: {.callout-tip title="Hands-On Practice"}
...
## Course Materials {#sec-course-materials}
