...
## Ch. 2 – Computer Systems (`02-computer-systems.qmd`)
...
## Ch. 3 – Unix Fundamentals (`03-unix-fundamentals.qmd`)
...
## Ch. 4 – Files, Pipes, Redirection (`04-files-pipes.qmd`)
...
## Ch. 5 – GREP and Regular Expressions (`05-grep-regex.qmd`)
...
## Ch. 6 – Shell Scripting (`06-shell-scripting.qmd`)
...
## Ch. 7 – R Programming (`07-r-programming.qmd`) and R appendix
...
## Ch. 12 (book order 13) – Quarto (`12-quarto-documents.qmd`)
...
## Ch. 10 (book order 15) – Git and GitHub (`10-git-github.qmd`) and Git appendix
...
## Ch. 11 (book order 16) – HPC / Talapas (`11-hpc-talapas.qmd`) and SLURM appendix
