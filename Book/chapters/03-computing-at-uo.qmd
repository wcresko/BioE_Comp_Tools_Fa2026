...
UO classifies data by the harm that would result if it were exposed, and the classification determines where it may be stored and which tools may touch it. **Know the class of your data before you choose where to put it.** @tbl-data-classification summarizes the three classes.
...
To understand why a cluster matters, compare it with the laptop you are reading this on. @tbl-laptop-vs-talapas puts the numbers side by side.
