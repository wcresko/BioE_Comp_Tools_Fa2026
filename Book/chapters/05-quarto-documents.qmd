...
- Render documents to multiple output formats from your IDE and the command line
:::
...
### From VS Code or Positron {#sec-from-rstudio}

- Click the **Preview** button (Quarto extension), or
