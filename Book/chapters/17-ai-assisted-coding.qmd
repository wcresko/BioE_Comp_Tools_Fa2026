...
%%| label: fig-ai-loop
%%| echo: false
%%| fig-cap: "The productive loop for working with an AI coding assistant. The step people skip is the one that matters."
flowchart LR
    A[Describe the goal precisely] --> B[Get code]
    B --> C[READ it]
    C --> D[Run it on a tiny test]
    D --> E[Check against something you know]
    E -->|wrong| A
    E -->|right| F[Use it, and keep the test]
