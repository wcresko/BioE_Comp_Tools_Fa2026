...
This appendix provides a comprehensive reference for regular expression (regex) patterns used in text processing with tools like `grep`, `sed`, `awk`, and R. The tutorial treatment is in @sec-grep-regex.
...
: Basic metacharacters {#tbl-regex-basic-ref}
