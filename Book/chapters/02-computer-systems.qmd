...
![Basic computer system architecture showing the flow of data between input devices, the CPU, memory, storage, and output devices](../images/appendix_A_S02_computer_components.svg){#fig-computer-components fig-align="center" width="60%"}
...
![The fundamental cycle underlying all computer operations: fetch, decode, execute, store, and repeat](../images/appendix_A_S03_fetch_decode_execute.svg){#fig-fetch-decode-execute fig-align="center" width="85%"}
...
![Operating system architecture: applications reach the hardware only through system calls, the kernel, and device drivers](../images/appendix_A_S13_os_architecture.svg){#fig-os-architecture fig-align="center" width="70%"}
...
![Local computing architecture: one machine, one operating system, all hardware reached through the OS](../images/appendix_A_S21_local_computing_arch.svg){#fig-local-architecture fig-align="center" width="70%"}
...
![Simplified cluster architecture with a head node, compute nodes, and shared storage](../images/appendix_A_S24_cluster_computing.svg){#fig-cluster-architecture fig-align="center" width="70%"}
...
![Cloud computing architecture: regions, availability zones, and the compute, storage, and networking inside each](../images/appendix_A_S27_cloud_computing.svg){#fig-cloud-architecture fig-align="center" width="75%"}
...
![Evolution of computing paradigms from mainframes to modern hybrid approaches](../images/appendix_A_S18_computing_timeline.svg){#fig-computing-evolution fig-align="center" width="100%"}
