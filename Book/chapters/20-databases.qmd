...
**SQL** (Structured Query Language) is the standard language for working with databases. While we'll primarily use dbplyr to write dplyr code that gets translated to SQL, understanding SQL basics is valuable. @tbl-sql-clauses maps each SQL clause to the dplyr verb you already know from @sec-tidy-data.
