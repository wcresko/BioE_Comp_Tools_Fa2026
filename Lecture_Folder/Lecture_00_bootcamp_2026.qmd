...
::::: columns
::: {.column width="50%"}
![Normally output prints to the screen](images/w1_pipes_3.jpeg){width="100%"}
:::

::: {.column width="50%"}
![`>` sends it to a file instead](images/w1_pipes_4.jpeg){width="100%"}
:::
:::::
...
![Each command's output becomes the next command's input](images/w1_pipes_5.jpeg){fig-align="center" width="85%"}
