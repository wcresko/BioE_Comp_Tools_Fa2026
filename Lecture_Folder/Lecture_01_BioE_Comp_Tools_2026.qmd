...
- Install an *Integrated Development Environment* (IDE)
  ...
  - RStudio (https://posit.co/download/rstudio-desktop/) is the classic R-only alternative, also free
- Other IDEs
...
## Your laptop vs. Talapas - by the numbers
...
- When an analysis says "out of memory" or would take days on your laptop - that's a job for Talapas (Lecture 08)
:::
