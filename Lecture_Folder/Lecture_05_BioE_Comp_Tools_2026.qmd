...
::: callout-tip
Rule of thumb: **`grep`** finds lines, **`sed`** edits text, **`awk`** works with columns. More in the course book's [GREP chapter](../book/chapters/05-grep-regex.html) and [Regular Expression Reference](../book/chapters/appendix-regex.html).
:::
