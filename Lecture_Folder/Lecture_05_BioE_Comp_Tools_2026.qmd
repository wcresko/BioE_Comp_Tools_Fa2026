...
-   [Ch. 7: GREP and Regular Expressions](../book/chapters/07-grep-regex.html)
-   *Reference:* [App. G: Regular Expression Reference](../book/chapters/appendix-G-regex.html)
...
::: callout-tip
Rule of thumb: **`grep`** finds lines, **`sed`** edits text, **`awk`** works with columns. More in the course book's [GREP chapter](../book/chapters/07-grep-regex.html) and [Regular Expression Reference](../book/chapters/appendix-G-regex.html).
:::
