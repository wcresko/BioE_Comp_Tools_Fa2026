...
::::: columns
::: {.column width="50%"}
![Normally a command's output goes to the screen](images/week_01_S130_pipe_step3.svg){width="100%"}
:::

::: {.column width="50%"}
![`>` sends that output to a file instead](images/week_01_S131_pipe_step4.svg){width="100%"}
:::
:::::
...
![Each command's output becomes the next command's input](images/week_01_S132_pipe_step5.svg){fig-align="center" width="90%"}
