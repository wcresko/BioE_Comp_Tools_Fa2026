...
-   [Ch. 5: Unix Fundamentals](../book/chapters/05-unix-fundamentals.html)
...
::: callout-tip
The **shell** expands wildcards *before* the command runs - so `rm *.fastq` deletes every matching file at once. Run `ls *.fastq` first to see exactly what will be affected. More in the [Unix Fundamentals chapter](../book/chapters/05-unix-fundamentals.html) of the course book.
:::
