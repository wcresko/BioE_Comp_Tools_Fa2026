...
::: callout-tip
The **shell** expands wildcards *before* the command runs - so `rm *.fastq` deletes every matching file at once. Run `ls *.fastq` first to see exactly what will be affected. More in [Appendix A](../Resources_Folder/Appendix_A_Computer_Systems_Command_Line.qmd).
:::
