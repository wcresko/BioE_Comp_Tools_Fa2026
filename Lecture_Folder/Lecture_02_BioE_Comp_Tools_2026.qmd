...
![](images/Lec03_img001.jpeg){fig-align="center" width="90%"}

## 

![](images/Lec03_img002.jpeg){fig-align="center" width="90%"}

## The way you normally navigate

![](images/Lec03_img003.jpeg){fig-align="center" width="90%"}

## 

![](images/Lec03_img004.jpeg){fig-align="center" width="90%"}
...
![](images/Lec03_img005.svg){fig-align="center" width="100%"}

## The Unix file hierarchy

![](images/Lec00_img004.svg){fig-align="center" width="90%"}

## Paths - the address of a file in the tree

![](images/Lec00_img005.svg){fig-align="center" width="90%"}

## Special files - the 'dot' entries

![](images/Lec03_img006.svg){fig-align="center" width="90%"}

## `.` refers to the directory you are in

![](images/Lec03_img007.svg){fig-align="center" width="90%"}

## `..` refers to the parent directory

![](images/Lec03_img008.svg){fig-align="center" width="90%"}

## Navigating with `..`

![](images/Lec00_img007.svg){fig-align="center" width="90%"}
...
::::: columns
::: {.column width="50%"}
![Normally a command's output goes to the screen](images/Lec00_img008.svg){width="100%"}
:::

::: {.column width="50%"}
![`>` sends that output to a file instead](images/Lec00_img009.svg){width="100%"}
:::
:::::
...
![Each command's output becomes the next command's input](images/Lec00_img010.svg){fig-align="center" width="90%"}
...
Download it into your project (once), then use what you learned today:

``` bash
mkdir -p ~/projects/comptools/data && cd ~/projects/comptools
curl -L -o data/Stickle_RNAseq.tsv https://wcresko.github.io/BioE_Comp_Tools_Fa2026/Data_Folder/Stickle_RNAseq.tsv
...
``` bash
head -n 2 data/Stickle_RNAseq.tsv | cut -f 1-8
```

    Individual  Genotype  Microbiota    Geno&Micro  Gene1  Gene2  Gene3  Gene4
    AC1         A         conventional  convA       16     15     71     153

::: incremental
-   One row per **fish**, one column per **variable** - tidy for per-fish questions
-   But **600 gene columns** is a "wide" layout: the *gene* is really a variable too. For per-gene questions we will reshape it to **long** format (one row per fish x gene) in Week 7
-   The `Geno&Micro` column duplicates two other columns - and the `&` is a name that will annoy every tool we use. Keep an eye on it.
:::
...
![](images/Lec03_img009.jpeg){fig-align="center" width="100%"}

## 

![](images/Lec03_img010.jpeg){fig-align="center" width="90%"}
