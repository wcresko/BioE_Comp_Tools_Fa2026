---
title: "Lecture 09 - Computational Tools for Bioengineers"
...
-   [Ch. 18: LaTeX for Scientific Documents](../book/chapters/18-latex-basics.html)
-   [Ch. 19: Coding with AI Assistants](../book/chapters/19-ai-assisted-coding.html)
-   [Ch. 20: Version Control with Git and GitHub](../book/chapters/20-git-github.html)
-   *Reference:* [App. H: LaTeX Command Reference](../book/chapters/appendix-H-latex.html)
...
-   Open a new Quarto Markdown document with **File → New File → Quarto Document** in VS Code / Positron / RStudio
...
-   In **RStudio**: the **Render** button (same shortcut)
-   Same source, many outputs: HTML, PDF, Word, slides, websites
:::

## Running example: a stickleback report in Quarto

One `.qmd` file: prose, the analysis, the figure, and the numbers in the text - all regenerated on every render.
...
::: callout-tip
The inline code (`r knitr::inline_expr("...")` inside a sentence) means the numbers in your sentences can never disagree with your data. Add `format: pdf` (once TinyTeX is installed) and the same file becomes a manuscript-ready PDF.
:::
...
-   Full syntax reference: the course book's [Quarto chapter](../book/chapters/05-quarto-documents.html)
:::
...
-   Course book chapter: [Coding with AI Assistants](../book/chapters/19-ai-assisted-coding.html) - worked examples in R and bash, a review checklist, prompting template, exercises with planted bugs
