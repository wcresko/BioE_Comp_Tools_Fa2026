...
-   [Ch. 17: LaTeX for Scientific Documents](../book/chapters/17-latex-basics.html)
-   [Ch. 18: Coding with AI Assistants](../book/chapters/18-ai-assisted-coding.html)
-   [Ch. 19: Version Control with Git and GitHub](../book/chapters/19-git-github.html)
...
-   Open a new Quarto Markdown document with **File → New File → Quarto Document** in VS Code / Positron
...
-   Course book chapter: [Coding with AI Assistants](../book/chapters/18-ai-assisted-coding.html) - worked examples in R and bash, a review checklist, prompting template, exercises with planted bugs
