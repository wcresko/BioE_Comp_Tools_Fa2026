...
-   *Reference:* [App. B: Git Command Reference](../book/chapters/appendix-B-git.html)
...
3.  Make changes in RStudio, VS Code or Positron (`.qmd` files with R or Python chunks)
