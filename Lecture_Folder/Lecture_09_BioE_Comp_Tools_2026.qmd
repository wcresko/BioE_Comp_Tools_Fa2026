...
We measured `r n_distinct(long$gene)` genes in `r nrow(stickle)` fish
(@fig-gene1).
...
::: callout-tip
The `` `r ... ` `` inline code means the numbers in your sentences can never disagree with your data. Add `format: pdf` (once TinyTeX is installed) and the same file becomes a manuscript-ready PDF.
:::
