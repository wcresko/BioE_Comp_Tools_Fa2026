...
-   [Ch. 9: R Programming Fundamentals](../book/chapters/09-r-programming.html)
-   [Ch. 10: Python Programming Fundamentals](../book/chapters/10-python-programming.html)
-   [Ch. 11: Tidy Data Principles](../book/chapters/11-tidy-data.html)
-   [Ch. 12: Data Visualization with ggplot2](../book/chapters/12-data-visualization.html)
-   *Reference:* [App. C: R Command Reference](../book/chapters/appendix-C-r.html) · [App. D: Python Quick Reference](../book/chapters/appendix-D-python.html)
...
-   More in the course book's [R Programming chapter](../book/chapters/09-r-programming.html) and [R Command Reference](../book/chapters/appendix-C-r.html)
:::
...
::: callout-tip
`facet_wrap(~ group)` splits any plot into one panel per group, and `ggsave("figure.pdf")` writes the last plot to a file. Data-visualization mechanics get a full chapter in the [course book](../book/chapters/12-data-visualization.html).
:::
