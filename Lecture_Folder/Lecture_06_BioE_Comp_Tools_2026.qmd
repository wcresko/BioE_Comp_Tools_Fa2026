...
::: callout-tip
`check.names = FALSE` keeps the column name `Geno&Micro` as it is in the file; without it R would rename it `Geno.Micro`. Either way, wrapping an awkward name in back-ticks lets you refer to it:
