...
-   This is a 1-credit hour course, so you should expect to complete \~ 30-40 hours of work for the course, or about 4 hours each week (this includes time in-class).
...
-   We will also be using this GitHub Pages website (<https://wcresko.github.io/BioE_Comp_Tools_Fa2026/>) for the course as the repository for lecture schedule, syllabus, lecture slides and other materials.
...
Generative AI tools (ChatGPT, Claude, Gemini, GitHub Copilot, and the AI assistants built into Positron and VS Code) are part of modern computational work, and learning to use them well - and to recognize when they are wrong - is a goal of this course (Week 9). In this class you **may** use GenAI as a *process* aid: to explain an error message, suggest how a command or function works, sketch an approach, or help you debug code you have written. You **may not** submit GenAI *content* as your own: every line of code, prose, and every figure you turn in must be something you wrote, understood, and can explain, and you must be able to run it yourself. If you do use a GenAI tool for any part of an assignment, add a brief note saying which tool you used and for what (e.g., "asked Copilot to explain the `awk` syntax in step 3"); undisclosed use, or submitting generated work as your own, is academic misconduct under the [Student Conduct Code](https://policies.uoregon.edu/vol-3-administration-student-affairs/ch-1-conduct/student-conduct-code) and will be reported to the Office of Student Conduct and Community Standards. Because these tools keep what you paste into them, never paste unpublished lab data, protected data (human subjects, HIPAA, FERPA), or anything covered by a data-use agreement; UO's [GenAI data-privacy guidance](https://teaching.uoregon.edu/ai-data-privacy) explains what is and is not safe. This policy follows UO's [guidance on GenAI in courses](https://teaching.uoregon.edu/ai) ("GenAI use allowed with specific limitations"); if you are unsure whether a particular use is okay, ask me first.
