...
We will hold class on Mondays from 4:00 to 5:00PM in KC2 213 (September 28 - November 30, 2026), preceded by a kick-off bootcamp on Thursday, September 24 from 9:00AM to 1:00PM in the KC2 Seminar Room. These meetings will be relatively informal, and will usually begin with a 30-45 min. conceptual overview of topics with coding demonstrations. I will post all lecture slides as Markdown and HTML after class to the course website under the 'Lectures' tab. The online course book, [*Foundational Computational Tools for Bioengineers*](book/index.html), is the required reading; the [Schedule](Schedule.qmd) and [Lectures](Lectures.qmd) pages list the chapters that go with each week, including the bootcamp. The remaining meeting time will be reserved for group work, questions, answers, and discussion. I encourage students to work on exercises and assignments during these periods so that questions can be directly addressed as they emerge.
...
-   *Scientific Computing Fundamentals*
    ...
    -   Read and write code in R and Python using VS Code, Positron or RStudio.
...
-   Computers and data
    ...
    -   Basics of data structures, databases and tidy data; properly organize and format primary data and metadata files for analysis
-   Integrative developer environments (IDEs)
    -   Visual Studio Code (VS Code) and Positron
    -   RStudio
    -   Jupyter notebooks
...
-   Reproducible science
    -   the NIH FAIR (Findable, Accessible, Interoperable, Reusable) principles
...
-   Remote super computing
    ...
    -   Other remote systems such as AWS and Azure
